...
- (void)viewDidLoad {
    ...
    UIBarButtonItem *item1 = [[UIBarButtonItem alloc] initWithTitle:@"位置"
                                                              style:UIBarButtonItemStylePlain
                                                             target:self
                                                             action:@selector(resetLocation)];
    
    UIBarButtonItem *item2 = [[UIBarButtonItem alloc] initWithTitle:@"状态"
                                     style:UIBarButtonItemStylePlain
                                    target:self
...
- (void)setupUI {
    ...
    NSArray *locationArr = [WJRegionManager shareInstance].locationArr;
...
- (void)getNowStatus {
    [[WJRegionManager shareInstance] getNowStatus];
}
